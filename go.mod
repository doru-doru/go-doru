module github.com/doru-doru/go-doru/v0

go 1.14

require (
	github.com/aws/aws-sdk-go v1.32.11 // indirect
	github.com/bwplotka/bingo v0.4.0 // indirect
	...
	github.com/textileio/go-ds-mongo v0.1.5-0.20201230201018-2b7fdca787a5 // indirect
